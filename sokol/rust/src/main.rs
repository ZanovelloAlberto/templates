...
use sokol::{
    app::{
        self as sapp,
        ffi::{sapp_heightf, sapp_widthf},
    },
    debugtext::{
        ffi::{sdtx_canvas, sdtx_draw, sdtx_font_oric, sdtx_pos, sdtx_puts, sdtx_setup},
        Desc,
    },
    gfx as sg, gl as sgl, glue as sglue,
    log::{ffi::slog_func, slog_func},
};
...
extern "C" fn init() {
    ...
    unsafe {
        ...
        // sdtx_setup(&Desc {
        //     context_pool_size: todo!(),
        //     printf_buf_size: todo!(),
        //     fonts: [sdtx_font_oric(),null,0,0,0,0,0,0 ],
        //     context: todo!(),
        //     allocator: todo!(),
...
extern "C" fn frame() {
    ...
    //     sdtx_pos(0.5, 0.5);
    //     sdtx_puts("ciao mamma".as_ptr() as *const i8);
    // };
